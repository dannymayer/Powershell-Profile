...
#region Check Connectivity to GitHub
...
function Update-Profile
{
  try
  {
    $url = "https://raw.githubusercontent.com/dannymayer/Powershell-Profile/refs/heads/main/Microsoft.PowerShell_profile.ps1"
...
Write-Host $dashImage -ForegroundColor Cyan
#endregion
...
{
  Set-Location C:\Users\danma\AppData\Local\nvim
  nvim
}
Set-Alias -Name evc -Value Edit-VimConfig
